    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between items-center mb-5">
          ...
          <span className="text-[#dbdbedbe] text-[16px]">
            {" "}
            {vieweddOrder?.cartItems?.length} Product{" "}
          </span>
        </div>
        <div className="flex justify-between items-center mb-5">
          ...
          <span className="text-[#dbdbedbe] text-[16px]">
            {" "}
            {vieweddOrder?.paymentMethodType}{" "}
          </span>
        </div>
        <div className="flex justify-between items-center mb-5">
          ...
          <span className="text-[#dbdbedbe] text-[16px]">
            {" "}
            {vieweddOrder?.isPaid ? "Done" : "Pending"}{" "}
          </span>
        </div>
        <div className="flex justify-between items-center mb-5">
          ...
          <span className="text-[#dbdbedbe] text-[16px]">
            {" "}
            {vieweddOrder?.isDelivered ? "Done" : "Pending"}{" "}
          </span>
        </div>
